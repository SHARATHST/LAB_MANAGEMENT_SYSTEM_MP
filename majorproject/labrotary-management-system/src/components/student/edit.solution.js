...
const Editsolution = (props ) =>{
  ...
  <form  className="Register-screen__form">
    <h3 className="Register-screen__title" style={{backgroundColor:'white'}}>Solution Edit</h3>
    {error && <span className="error-message">{error}</span>}
    <div className="form-group" style={{backgroundColor:'white'}}>
      <label htmlFor="qno" style={{backgroundColor:'white',fontWeight:'bolder',textAlign:'left',float:'left'}}>
      Qno:{" "}
    ...
    <div className="form-group" style={{backgroundColor:'white'}}>
      <label htmlFor="solution" style={{backgroundColor:'white',fontWeight:'bolder',textAlign:'left',float:'left'}}>
      Solution:{" "}
