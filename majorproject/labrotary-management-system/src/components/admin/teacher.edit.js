...
const Teacheredit = () =>{
    ...
    <center><div>
      ...
      <button style={{borderRadius:5,border:"solid",padding:"5px 20px",width:'145px' , backgroundColor: 'rgb(0, 183, 255)'}} onClick={()=>backhandler()}>Back</button><br></br>
      <ul>
      <button style={{borderRadius:5,border:"solid",padding:"5px 20px",margin:10,backgroundColor: 'rgb(0, 183, 255)'}} onClick={()=>registerteacher()}>Register Teacher</button>  <br></br>
      <div id ="addteacher">
        </div>  
        <button style={{borderRadius:5,border:"solid",padding:"5px 29px",margin:10,width:'150px',backgroundColor: 'rgb(0, 183, 255)'}} id="removeonclick" onClick={()=>addteacher()}>Add Teacher</button> <br></br>
      <br></br>
  ...
  <button style={{padding:"5px 25px",border:"2px solid black",borderRadius:5,backgroundColor: 'rgb(0, 183, 255)'}}  onClick={logout} >Logout</button>
