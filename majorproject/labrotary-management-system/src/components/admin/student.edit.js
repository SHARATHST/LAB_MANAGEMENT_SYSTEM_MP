  ...
  const removehandler = async (_id)  => {
    ...
    return(
       <center><div>
         ...
         <div>
         <h3>{location.state.name} Subject </h3>
         {error && <span className="error-message">{error}</span>}
          <button style={{padding:"5px 25px",border:"2px solid black",borderRadius:5,width:'150px',margin:"15px",backgroundColor: 'rgb(0, 183, 255)'  }} onClick={()=>backhandler()}>Back</button><br></br>
        <ul> 
        <button style={{padding:"5px 25px",border:"2px solid black",borderRadius:5,width:'155px',margin:"15px",backgroundColor: 'rgb(0, 183, 255)'}} onClick={()=>registerstudent()}>Register Student</button> 
        <div id ="addstudent">
        </div>
        <button style={{padding:"5px 25px",border:"2px solid black",borderRadius:5,width:'150px',margin:"15px",backgroundColor: 'rgb(0, 183, 255)'}} id="removeonclick" onClick={()=>addstudent()}>ADD Student</button> 
     ...
     <button style={{padding:"5px 25px",border:"2px solid black",borderRadius:5,margin:"15px",width:'150px',backgroundColor: 'rgb(0, 183, 255)'}} onClick={logout} >Logout</button>
 </div> }
    </div>}
       </div>
       </center>
